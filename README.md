...
| `LOG_LEVEL` | `info` (prod) / `debug` (dev) | Controls structured logger verbosity. |
...
- **Logging:** Structured JSON logger (`server/utils/logger.js`) writes to stdout with configurable `LOG_LEVEL`. Ship to your log aggregator or pipe through `pino-pretty` locally.
...
- [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) – Module boundaries, data flow, and deployment topology.
- [`docs/OPERATIONS.md`](docs/OPERATIONS.md) – Runbooks for health checks, incidents, and deployments.
- [`docs/SECURITY.md`](docs/SECURITY.md) – Reporting process and ongoing security tasks.
- [`docs/MIGRATIONS.md`](docs/MIGRATIONS.md) – Template for data/infrastructure changes.
